...
public:
    ...
    SourcePath decodePath(std::string_view s, PosIdx pos, std::string_view errorCtx);
    ...
    std::string decodePaths(std::string_view s, PosIdx pos, std::string_view errorCtx);
